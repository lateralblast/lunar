...
# Refer to Section(s) 9.2.7,12-4 Page(s) 192-3,197-200 CIS Red Hat Enterprise Linux 5 Benchmark v2.1.0
# Refer to Section(s) 9.2.7,12-4 Page(s) 170,174-6     CIS Red Hat Enterprise Linux 6 Benchmark v1.2.0
# Refer to Section(s) 6.2.7,9    Page(s) 281,3         CIS Red Hat Enterprise Linux 7 Benchmark v2.1.0
