...
#    daemon_check=`ps -ef | grep "kube-apiserver" |grep -v grep`
    ...
    if [ "$daemon_check" ]; then
      ...
      if [ -f "$check_file" ]; then
        ...
        # check_file_value is $check_file "--enable-admission-plugins" eq "AlwaysAdmit" hash # no
        ...
        # check_file_value is $check_file "--enable-admission-plugins" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--kubelet-client-certificate" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--kubelet-client-key" eq "[A-Z,a-z]" hash
        ...
        # check_file_value is $check_file "--service-account-key-file" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--etcd-certfile" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--etcd-keyfile" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--enable-admission-plugins" eq "ServiceAccount" hash no
        # check_file_value is $check_file "--tls-cert-file" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--tls-private-key-file" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--client-ca-file" eq "[A-Z,a-z]" hash
        ...
        # check_file_value is $check_file "--etcd-cafile" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--enable-admission-plugins" eq "NodeRestriction" hash yes
        # check_file_value is $check_file "--experimental-encryption-provider-config" eq "[A-Z,a-z]" hash
        ...
        # check_file_value is $check_file "--admission-control-config-file" eq "[A-Z,a-z]" hash
        # check_file_value is $check_file "--feature-gates" eq "AdvancedAuditing=false" hash no
      fi
