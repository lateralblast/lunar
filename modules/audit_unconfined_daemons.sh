...
# Refer to Section(s) 1.4.6 Page(s) 45-6 CIS Red Hat Enterprise Linux 5 Benchmark v2.1.0
# Refer to Section(s) 1.4.6 Page(s) 43   CIS Red Hat Enterprise Linux 6 Benchmark v1.2.0
#.
