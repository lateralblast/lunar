...
# audit_azure_app_service_deployment_slot_ftp_state
#
...
audit_azure_app_service_deployment_slot_ftp_state () {
  print_function "audit_azure_app_service_deployment_slot_ftp_state"
  check_message  "Azure App Service Deployment Slot FTP State"
